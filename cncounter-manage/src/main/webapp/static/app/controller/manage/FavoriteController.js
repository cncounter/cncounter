 ...
 * controller - 收藏
 */
Ext.define('ESSM.controller.manage.FavoriteController', {
	extend  : 'Ext.app.Controller',
	views : ['manage.FavoriteView','manage.FavoriteForm','manage.FavoriteGrid'],
	...
	getMainView : function(){
		return this.getView('manage.FavoriteGrid');
	},
	...
	init : function() {
		this.control({
            ...
            'grid button[action=create]' : {
                click : this.onCreateFavorite
            },
            'grid button[action=update]' : {
                click : this.onUpdateFavorite
            },
    ...
    getEditWin : function(title, record, saveFn, saveFnContext){
        //
        var editForm = Ext.create('ESSM.view.manage.FavoriteForm',{
            flex:8,
            saveFn : saveFn,
